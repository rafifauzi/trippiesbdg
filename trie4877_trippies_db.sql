...
--
-- Host: localhost:3306
-- Waktu pembuatan: 05 Mar 2019 pada 21.15
-- Versi server: 10.2.21-MariaDB-cll-lve
-- Versi PHP: 7.2.7
...
('ADM231020181', 'Rafi Fauzi', '23', 'admin.jpg', 'admin-sampul.jpg', 'admin', 'trippiesbdg@gmail.com', '');
...
('', 'BNI', 'Imelda Pangaribuan', '0753502492'),
...
('BR071120181', 'Gantungan Handphone / Gantungan Kunci Disney Cute Fashion Accesories', 22, 150, 15000, 15300, 1, 119, 'Gantungan Boneka \r\nBisa dijadikan Gantungan Kunci dan juga bisa dijadikan Gantungan Handphone\r\n\r\nItem yang sangat Imut \r\nHanya tersedia 3 model seperti digambar ya...\r\n\r\nHarap tanyakan stok terlebih dahulu sebelum memesan\r\n\r\nWajib cantumkan nama boneka di catatan atau random', '2018-11-07', 'KB2', 'S271020181'),
('BR071120182', 'Topi Baymax Eyes By Crion', 27, 150, 35000, 35700, 1, 21, 'Topi Jaring Tipe Trucker\r\n\r\nSablon mengunakan Sablon Flock Timbul (memberikan Effect Timbul cocok untuk penganti bordir dengan daya tahan tinggi)\r\n\r\nall size (Size dapat diatur)\r\n\r\nWarna sesuai gambar', '2018-11-07', 'KB2', 'S271020181'),
('BR141120181', 'gantungan kunci ukuran 2 x 6 cm', 1, 1, 8000, 8160, 1, 17, 'Gantungan Kunci dengan ragam desain yang yang dapat memotivasi dan menginspirasi', '2018-11-14', 'KB2', 'admin'),
('BR141120182', 'Intensive UV Sunblock Cream SPF 50 merk 3W Clinic', 1, 500, 120000, 122400, 1, 12, 'Sun block dengan SPF 50 yang dapat di gunakan pada wajah dan badan. Produk ini mengandung moisturizer yang akan melembabkan bagian tubuh yang dioles.', '2018-11-14', 'KB3', 'admin');
...
('BR141120181', 'BR141120181-1.jpg'),
('BR141120182', 'BR141120182-1.jpg');
...
('TR141120182', 'Goes To  Vietnam', 5000000, '2019-02-06', '2019-02-10', 'Hanoi, Notre -dame, Sapa, hue, halong bay', 'Vietnam yang relatif baru membuka diri dari ketertutupan era komunisme memiliki banyak spot - spot eksotik. selain itu harga di vietnam relatif murah', 'Hari 1 :\r\nPerjalanan Cgk - Hanoi\r\nMenginap di Hostel\r\nHari 2 :\r\nKeliling kota Hanoi, mengunjungi Notre-Dame\r\nHari 3 :\r\nPerjalanan menuju Sapa\r\nTracking di Sapa\r\nMenginap di Sapa\r\nHari 4 :\r\nEksplor Halong Bay dengan Boat, eksplor Hue\r\nHari 5 :\r\nLembali ke Hanoi dan Perjalanan kembali ke Indonesia. ', 'Transportasi selama di vietnam (sleepper train, bus, perahu)\r\nMakan 10 x\r\nPenginapan\r\nBiaya Tiket Masuk', 'Tiket Pesawat\r\nPembuatan Paspor\r\nPengeluaran Pribadi\r\nTip Guide', 'tidak boleh', 'Rp', 'blank_image.jpg', '2018-11-14'),
...
--
-- Indeks untuk tabel `tb_detail-transaksi`
--
...
--
-- Indeks untuk tabel `tb_ngiklan`
--
ALTER TABLE `tb_ngiklan`
  ADD PRIMARY KEY (`no_iklan`);

--
-- Indeks untuk tabel `tb_opentrip`
--
