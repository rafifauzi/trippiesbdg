                    ...
                    <div class="menu-extras" <?=$display;?>>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown notification-list" <?=$tNotif;?>>
                                <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" href="list-transaksi-penjual">
                            ...
                            <li class="nav-item dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow profile-dropdown " aria-labelledby="Preview">
                                    ...
                                    <!-- item-->
                                    <a href="list-transaksi-barang" class="dropdown-item notify-item">
                                        <span>Transaksi</span>
                                    </a>
                ...
                <div class="container">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li><a href="iklan">Pasang Iklan</a></li>
                        </ul>
                        <!-- End navigation menu  -->
                    </div>
                </div>
