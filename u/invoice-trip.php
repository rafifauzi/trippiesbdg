                    ...
                    <div class="col-xs-12">
                        <div class="card-box">
                            ...
                            <div class="panel-body">
                                <?php
                                    $qInvoice=mysql_query("SELECT * FROM tb_booking JOIN tb_opentrip ON tb_booking.id_trip=tb_opentrip.id_trip JOIN tb_user ON tb_booking.id_user=tb_user.id_user WHERE `tb_booking`.`id_booking`='$noInvoice'") or die(mysql_error());
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="pull-right m-t-1">
                                        <table>
                                            <tr>
                                                <td width="140"><h3>No Booking</h3></td>
                                                <td width="20"><h3>:</h3></td>
                                                <td><h3><?=$rInvoice['id_booking'];?></h3></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                        ...
                                        <div class="pull-xs-right m-t-30">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><?=tanggal($rInvoice['tgl_bayar']);?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="table-responsive">
                                            <table class="table m-t-30">
                                                ...
                                                <tbody>                                                   
                                                    <tr>
                                                        <td><?=$rInvoice['id_trip'];?></td>
                                                        <td><?=$rInvoice['nama_paket'];?></td>
                                                        <td><?=tanggal($rInvoice['periodeAwal'])." - ".tanggal($rInvoice['periodeAkhir']);?></td>
                                                        <td><?=$rInvoice['lokasi'];?></td>
                                                        <td><?=rupiah($rInvoice['harga']);?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6 col-md-offset-3">
                                        <div class="pull-xs-right m-t-30">
                                            <h4>Total Bayar</h4>
                                            <hr>
                                            <h3 class="text-xs-right"><?=rupiah($rInvoice['harga']);?></h3>
                                        </div>
