                    ...
                    <div class="col-xs-12">
                        <div class="card-box">
                            ...
                            <div class="panel-body">
                                <?php
                                    $qInvoice=mysql_query("SELECT * FROM `tb_transaksi` JOIN `tb_user` ON `tb_transaksi`.`id_user`=`tb_user`.`id_user` JOIN tb_bank ON tb_transaksi.id_bank=tb_bank.id_bank JOIN tb_kota ON tb_user.kota=tb_kota.id_kota WHERE `no_invoice`='$noInvoice'") or die(mysql_error());
                                    ...
                                    $dBank=$rInvoice['nama_bank']." - ".$rInvoice['nama_pemilik'];
                                    ...
                                    <div class="col-xs-5">
                                        <div class="pull-xs-left m-t-30">
                                            <address>
                                              ...
                                              <div style="width: 70%;">
                                                  <?=$rInvoice['alamat'];?><br>
                                                  <?=$rInvoice['nama_kota']." / ".$rInvoice['kodepos'];?><br>
                                                  <?=$rInvoice['no_hp'];?>
                                              </div>
                                              </address>
                                        </div>
