			 ...
			 <div class= \"form-group\">
				...
				<select class=\"form-control\" name='kurir' id='harga' onchange='hitungOngkir(this.value)'>";
					...
					for ($l=0; $l < count($data['rajaongkir']['results'][$k]['costs']); $l++) {
						echo "<option value='".$data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['value']."'>".$data['rajaongkir']['results'][$k]['costs'][$l]['service'], $data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['etd'], $data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['value']."</option>";
					}
					echo "</select>
