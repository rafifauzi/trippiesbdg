...
<html>
    ...
    <body>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <a href="detail-barang?id=<?=$r['id_barang']?>"><button class="form-control btn btn-sm btn-primary waves-effect waves-light">Detail</button></a>
                                            <form method="POST" action="proses-store">
        ...
        <script>
            var resizefunc = [];
            function addCerita() {
                window.location.assign('tambah-barang.php');
            }
            function noneCerita() {
