    ...
    <div class="modal fade modal-custom" id="iklan">
        <div class="modal-dialog">
            ...
            <div class="modal-body ">
                <form method="GET" action="list-pembukuan-iklan">
        ...
        <div class="container">
            ...
            <div class="card-box">
                ...
                <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php 
                            $q=mysql_query("SELECT * FROM `tb_ngiklan` JOIN `tb_detail-ngiklan` ON `tb_ngiklan`.`no_iklan`=`tb_detail-ngiklan`.`no_iklan` JOIN tb_iklan ON `tb_detail-ngiklan`.`id_iklan`=`tb_iklan`.`id_iklan` WHERE `tb_ngiklan`.`tgl_bayar` BETWEEN '$tglAwal' AND '$tglAkhir' ORDER BY `tb_ngiklan`.`tgl_bayar`") or die(mysql_error());
            ...
            <div class="card-box">
                <h4>Pengeluaran Iklan (Transaksi Gagal)</h4><hr>
                <div style="width: 100%; height: 300px; overflow-x: scroll; overflow-y: scroll;">                    
                <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                ...
                <h5>Total Pengeluaran Admin : <?=rupiah($gagal5);?></h5>
            </div>            
        </div>
    </div>
       <script>
